                ...
                updates.forEach((key, value) -> {
                    switch (key) {
                        ...
                        case "complaintStatus": {
                            ...
                            if ("Pending For Closed".equals(newVal) && existingLog.getPendingForClosedDate() == null) {
                                Date autoDate = Date.valueOf(LocalDate.now());
                                existingLog.setPendingForClosedDate(autoDate);
                                saveComplaintHistory(existingLog.getComplaintId(), "pendingForClosedDate", null, autoDate.toString(), "Status-triggered update");
                            }
