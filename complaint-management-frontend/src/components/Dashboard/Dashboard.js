...
function Dashboard() {
  ...
  const [showHardwareRequestList, setShowHardwareRequestList] = useState(false);
...
useEffect(() => {
  ...
  const handleNavigation = (view) => {
    ...
    setShowHardwareRequestList(false);
    setShowHardwareRequestForm(false);
    ...
    switch (view) {
      ...
      case "hardware-request-form":
        setShowHardwareRequestForm(true);
        break;
      ...
      case "overall-metrics":
        ...
        break;
      case "hardware-request-list":
        setShowHardwareRequestList(true);
        break;
